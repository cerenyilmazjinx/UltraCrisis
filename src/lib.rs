...
#[derive(Debug)]
pub struct UltraCrisisProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UltraCrisisProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UltraCrisis processing");
    
    let mut processor = UltraCrisisProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UltraCrisisProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UltraCrisisProcessor::new(false);
